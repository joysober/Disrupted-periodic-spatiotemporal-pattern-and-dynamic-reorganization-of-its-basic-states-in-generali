...
pathpng='../Results/png_SbjPSTP/'; %%save the fit curves of the DMN and TPN 
if ~exist(pathpng,'dir'), mkdir(pathpng); end
pathpngz='../Results/png_SbjPSTP_zscore/';
...
save('../Results/ratio.mat','ratio_all','ratio_r_positve_PSTP_allsub','ratio_p_sig_PSTP_allsub',...
