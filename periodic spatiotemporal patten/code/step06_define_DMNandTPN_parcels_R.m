...
%%and then take the union across subjects.nG = length(ixG);
...
e.dtseries=O;
ft_write_cifti('../mask/DMN_TPN_parcels_R',e,'parameter','dtseries'); 
...
save('../mask/DMN_TPN_parcels_R.mat','mask_group','mask_group_zheng','mask_group_fu');
